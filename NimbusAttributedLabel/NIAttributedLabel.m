...
CGSize NISizeOfAttributedStringConstrainedToSize(NSAttributedString* attributedString, CGSize constraintSize, NSInteger numberOfLines) {
    ...
    CGSize textSize = [attributedString boundingRectWithSize:constraintSize options:NSStringDrawingUsesFontLeading context:nil].size;
    return CGSizeMake(NICGFloatCeil(textSize.width), NICGFloatCeil(textSize.height));
}
