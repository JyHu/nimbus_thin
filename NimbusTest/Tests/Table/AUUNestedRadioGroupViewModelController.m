//
//  AUUNestedRadioGroupViewModelController.m
//  NimbusTest
//
...
@interface AUUNestedRadioGroupViewModelController () <NIRadioGroupDelegate>

@property (retain, nonatomic) NIRadioGroup *radioGroup;

@end

@implementation AUUNestedRadioGroupViewModelController
