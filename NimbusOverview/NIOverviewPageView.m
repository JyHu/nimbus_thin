...
- (void)contentSizeChanged {
  ...
  _logScrollView.frame = CGRectMake(0, 0,
    ...
    paragraphStyle.lineBreakMode = _logLabel.lineBreakMode;
    CGSize labelSize = [_logLabel.text boundingRectWithSize:CGSizeMake(_logScrollView.bounds.size.width, CGFLOAT_MAX) options:NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName : _logLabel.font, NSParagraphStyleAttributeName : paragraphStyle} context:nil].size;
...
- (CGFloat)drawTitle:(NSString *)title
  ...
  UIFont *infoFont = [UIFont systemFontOfSize:[UIFont systemFontSize]];
    CGSize size = [title sizeWithAttributes:@{NSFontAttributeName : infoFont}];
    [title drawAtPoint:point withAttributes:@{NSFontAttributeName : infoFont}]; // [title drawAtPoint:point withFont:infoFont];
  ...
  CGRect bounds = self.bounds;
    ...
    [value drawInRect:CGRectMake(point.x, point.y, bounds.size.width - point.x - kPadding, CGFLOAT_MAX) withAttributes:@{NSFontAttributeName : infoFont, NSParagraphStyleAttributeName : paragraphStyle}];
